...
/**
 * PrhBal2 entity. @author MyEclipse Persistence Tools
 */

public class PrhBal2 implements java.io.Serializable {
	...
	/** minimal constructor */
	public PrhBal2(String accnt, String roomno, Integer year, Integer month,
	...
	public PrhBal2(String accnt, String roomno, Integer year, Integer month,
			...
			Double ratem, Double rated, Double rate0, Double rate1,
			Double paid, Double paid0, Double paid1, Double bal, Double bal0,
			Double bal1, Double pamount) {
		this.accnt = accnt;
		this.roomno = roomno;
		this.year = year;
		this.month = month;

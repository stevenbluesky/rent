...
/**
 * PrhRentalDel entity. @author MyEclipse Persistence Tools
 */

public class PrhRentalDel implements java.io.Serializable {
	...
	/** minimal constructor */
	public PrhRentalDel(String accnt, Integer inumber, String orgid,
			...
			Date edate, Double amount, Integer prttimes, String sta) {
		this.accnt = accnt;
	...
	/** full constructor */
	public PrhRentalDel(String accnt, Integer inumber, String flag,
			String orgid, String prtno, String name, String guestno,
			String roomno, String vroomno, String rmtype, Double rate,
			String fileno, Double number0, Double deposit, Double number,
			Double charge, Double charge1, Double charge2, Date bdate,
			Date edate, Double amount, String ref1, String ref2, String ref3,
			String ref4, String ref5, String prtid, String prtname,
			Date prtdate, Integer prttimes, String sta, String cashier,
			String cashname, Date cashdate, Date sysdate, String audit1,
			String logid1, Date audit1time, String audit2, String logid2,
			Date audittime, String iflag, String ino, String ilogid,
			String ilogname, Date isysdate, Date ilogdate, String method,
			String oroomno, Integer days, Integer fmonths, Integer fdays,
			Double famount, String cusno, Date logupdate) {
		this.accnt = accnt;
		this.inumber = inumber;
		this.flag = flag;
		this.orgid = orgid;

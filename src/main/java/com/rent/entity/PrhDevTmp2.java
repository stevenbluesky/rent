...
/**
 * PrhDevTmp2 entity. @author MyEclipse Persistence Tools
 */

public class PrhDevTmp2 implements java.io.Serializable {
	...
	/** full constructor */
	public PrhDevTmp2(String build, String roomno, String floor, String type,
			Integer area, Integer rate, Integer price, String vtype,
			String vroomno, Integer v1, Integer v2, Integer v3, Integer v4,

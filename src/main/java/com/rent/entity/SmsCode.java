...
/**
 * SmsCode entity. @author MyEclipse Persistence Tools
 */
...
public class SmsCode implements java.io.Serializable {
	// Fields
		...
		/** minimal constructor */
		public SmsCode(String id,String cls, String descript1, Integer len) {
			this.cls = cls;
			this.id = id;
		...
		/** full constructor */
		public SmsCode(String id,String cls, String descript1,
		...
		public boolean equals(Object other) {
			...
			return ((this.getCls() == castOther.getClass_()) || (this
					.getCls() != null && castOther.getClass_() != null && this
					.getCls().equals(castOther.getClass_())))

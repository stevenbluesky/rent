...
public abstract class BaseService {
	...
	/**
	 * 数据范围过滤
	 * @param user 当前用户对象，�?�过“entity.getCurrentUser()”获�?
	 * @param officeAlias 机构表别名，多个用�??,”�?�号隔开�?
	 * @param userAlias 用户表别名，多个用�??,”�?�号隔开，传递空，忽略此参数
	 * @return 标准连接条件对象
	 */

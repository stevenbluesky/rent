...
import com.rent.common.utils.CookieUtils;
...
public class Page<T> {
	...
	private String funcName = "page"; // 设置点击页码调用的js函数名称，默认为page，在�?页有多个分页对象时使用�??
	
	private String funcParam = ""; // 函数的附加参数，第三个参数�?��??
	
	private String message = ""; // 设置提示消息，显示在“共n条�?�之�?
	 ...
	 * @param request 传�?? repage 参数，来记住页码
	 * @param response 用于设置 Cookie，记住页�?
	 * @param defaultPageSize 默认分页大小，如果传�? -1 则为不分页，返回�?有数�?
	 */
	public Page(HttpServletRequest request, HttpServletResponse response, int defaultPageSize){
		// 设置页码参数（传递repage参数，来记住页码�?
		String n=request.getRequestURL().toString();
...
//	}
	...
	/**
	 * 设置点击页码调用的js函数名称，默认为page，在�?页有多个分页对象时使用�??
...
//	
//	/**
//	 * 设置 Spring data JPA 分页对象，转换为本系统分页对�?
//	 */

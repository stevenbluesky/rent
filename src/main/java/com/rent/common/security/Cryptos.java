...
public class Cryptos {
	...
	//-- HMAC-SHA1 funciton --//
	/**
	 * 使用HMAC-SHA1进行消息签名, 返回字节数组,长度�?20字节.
	 * 
	...
	/**
	 * 生成HMAC-SHA1密钥,返回字节数组,长度�?160�?(20字节).
	 * HMAC-SHA1算法对密钥无特殊要求, RFC2401建议�?少长度为160�?(20字节).
	 */

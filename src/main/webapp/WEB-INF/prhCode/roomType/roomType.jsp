...
<script type="text/javascript">
	...
	function toEdit() {
		...
		location.href = "toRoomTypeEdit.do?id=" + id;
...
<body>
	...
	<div id="tabs0">
		...
		<div class="main" id="main0">
			...
			<form id="myForm" action="roomTypeDel.do" method="post">
...
<tr >
			...
			<br/><div  class="pagination" id="numpage" > ${numpage}</div><br/>
				...
				<input class="btn" value="新 增" type="button"
					onclick="location.href='toRoomTypeAdd'" />

...
<script type="text/javascript">
	...
	function toEdit() {
		...
		if (count == 0) {
			$.jBox.tip("请选择要修改的配套设施类型！");
			return;
		} else if (count > 1) {
			$.jBox.tip("请勿选择多个配套设施类型！");
			return;
		}
		location.href = "toPaymentCodeEdit.do?id=" + id;
	}
...
<body>
	...
	<div id="tabs0">
		...
		<div class="main" id="main0">
			...
			<form id="myForm" action="paymentCodeDel.do" method="post">
			...
			<tr >
				...
				<input  value="新 增" type="button" class="btn"

...
<script type="text/javascript">
	...
	function toEdit() {
		...
		if (count == 0) {
			$.jBox.tip("请选择要修改的维修原因！");
			return;
		} else if (count > 1) {
			$.jBox.tip("请勿选择多个维修原因！");
			return;
		}
		location.href = "toRepaireReasonEdit.do?id=" + id;
	}
...
<body>
	...
	<div id="tabs0">
		...
		<div class="main" id="main0">
			...
			<form id="myForm" action="repaireReasonDel.do" method="post">
			...
			<tr ><th >选择<input type="checkbox"  class="chkAll" style="position: relative;top: 2px;"/> </th>
						<th>维修原因名</th>
					</tr>
		...
		<br/><div  class="pagination" id="numpage" > ${numpage}</div><br/>
				<input class="btn" value="新 增" type="button"
					onclick="location.href='toRepaireReasonAdd'" />
					
				<input class="btn" value="修 改" type="button" onclick="toEdit()" /> 
				
				<input class="btn"
					value="删 除" type="submit" onclick="del()" /> 
			</form>
		</div>
	</div>
	<br />

...
<script type="text/javascript">
	...
	function toEdit() {
		...
		if (count == 0) {
			$.jBox.tip("请选择要修改的补贴人类型！");
			return;
		} else if (count > 1) {
			$.jBox.tip("请勿选择多个补贴人类型！");
			return;
		}

		location.href = "toSubsidyTypeEdit.do?id=" + id;
...
<body>
	...
	<div id="tabs0">
		...
		<div class="main" id="main0">
			...
			<form id="myForm" action="subsidyTypeDel.do" method="post">
...
<br/><div  class="pagination" id="numpage" > ${numpage}</div><br/>
				<input class="btn" value="新 增" type="button"
					onclick="location.href='toSubsidyTypeAdd'" />

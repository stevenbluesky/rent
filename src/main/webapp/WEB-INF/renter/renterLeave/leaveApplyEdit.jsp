...
<html>
  ...
  function apply(){
		...
		$.ajax({
	        type: "POST",
	        dataType: "Text",
	        url: 'renterLeaveEdit.do',
	        data: $('#myForm').serialize(),
	        success: function () {
	        	$.jBox.tip("退租修改成功");
	       	    parent.layer.close(parent.layer.getFrameIndex(window.name));
	       		parent.applyResultEdit(1);
  ...
  <form id="myForm" method="post">
	   <table class="addFloor" border="0" bordercolor="#a0c6e5" >
	   		...
	   		<tr>
	   		   ...
	   		   <td><input type="text" name="refer2" value="${master.refer2}" ></td>
	   		</tr>
	   		<tr>
	   		   ...
	   		   <td>
	   		    	<%Date now= new Date(); request.setAttribute("now", now); %>
					           <input		
								name="cotime_" value="<fmt:formatDate value="${master.cotime}" pattern="yyyy-MM-dd" />" 
								type="date">
